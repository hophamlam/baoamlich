...
// below is all new functions added by hophamlam

function getNewDayString(lunar, solarDay, solarMonth, solarYear) {
  var s;
  var dayOfWeek = TUAN[(lunar.jd + 1) % 7];
  s = dayOfWeek + " " + solarDay + "/" + solarMonth + "/" + solarYear;
  s += " \nNhằm ÂL: ";
...
function getNewTodayString() {
  var s = getNewDayString(
    currentLunarDate,
    today.getDate(),
    today.getMonth() + 1,
    today.getFullYear()
